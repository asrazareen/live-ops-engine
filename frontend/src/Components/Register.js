...
return (
    <>
    {
     ...
     <div  className={`${message} ? "bg-opacity login-container" : "login-container"`} >
        ...
        <optgroup id="country-optgroup-Oceania" label="Oceania">
            ...
            <option value="WF" label="Wallis and Futuna">Wallis and Futuna</option>
                    ...
                    <div className="pass" >
                    <input className="password" placeholder="Enter your Password" onChange={(e) => {setPasword(e.target.value)}} />
                    {
                    ...
                    <p>Already have a Account? <span className="span" onClick={() => {navigate("/")}} >Login</span></p>
                </div>
            </div>
        </div>
    </>
